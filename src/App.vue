<template>
  <div class="h-screen relative h-full">
    <nav
    ...
    <div class="flex flex-col">
      ...
      <section id="chat" class="py-4 px-4 h-full">
        ...
        >
          <div
            class="flex justify-center items-center bg-black py-3 text-white"
          >
          ...
          >
            <div
              class="border-l-0 border border-solid border-b-gray-400 text-xs text-gray-800 flex justify-left items-center rounded-tl-sm rounded-tr-sm overflow-hidden"
            >
